...
class SampleTextSeeder extends Seeder
{
    ...
    private function getEnglishTexts(): array
    {
        return [
            ...
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'time flies fast'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'stars shine bright'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'he likes tea'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'we sing songs'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'rain falls down'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'she draws pictures'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'kids play games'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'wind blows strong'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'i drink coffee'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'trees grow tall'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'she smiles always'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'we enjoy nature'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'fish swim fast'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'he opens door'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'moon shines bright'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'i close window'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'they work hard'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'she teaches class'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'we need rest'],
            ['language' => 'english', 'difficulty' => 'beginner', 'text' => 'snow falls softly'],
            ...
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'setting goals helps achieve better results'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'staying focused is key to success'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'learning from mistakes makes us stronger'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'healthy habits improve our daily lives'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'positive thinking helps overcome difficult challenges'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'building confidence takes time and effort'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'asking questions shows you want learning'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'staying organized improves work efficiency greatly'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'taking breaks refreshes your mind completely'],
            ['language' => 'english', 'difficulty' => 'intermediate', 'text' => 'clear communication prevents many workplace problems'],
    ...
    private function getJapaneseTexts(): array
    {
        return [
            ...
            ['language' => 'japanese', 'difficulty' => 'beginner', 'text' => 'ame', 'text_variants' => ['ame'], 'display_text' => '飴', 'reading' => 'あめ'],
            ...
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'shigotoniru', 'text_variants' => ['shigotoniru', 'sigotoniru'], 'display_text' => '仕事に行く', 'reading' => 'しごとにいく'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'kaimonomiru', 'text_variants' => ['kaimonomiru'], 'display_text' => '買い物する', 'reading' => 'かいものする'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'yuuhantubu', 'text_variants' => ['yuuhantubu', 'yuuhantubu', 'yuhantubu'], 'display_text' => '夕飯食べる', 'reading' => 'ゆうはんたべる'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'shukudaibu', 'text_variants' => ['shukudaibu', 'syukudaibu'], 'display_text' => '宿題する', 'reading' => 'しゅくだいする'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'souzisuru', 'text_variants' => ['souzisuru', 'soudisuru', 'sozisuru'], 'display_text' => '掃除する', 'reading' => 'そうじする'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'sentakuru', 'text_variants' => ['sentakuru', 'senntakuru'], 'display_text' => '洗濯する', 'reading' => 'せんたくする'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'samposuru', 'text_variants' => ['samposuru', 'sanmposuru', 'sampposuru'], 'display_text' => '散歩する', 'reading' => 'さんぽする'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'nemurumae', 'text_variants' => ['nemurumae'], 'display_text' => '眠る前に', 'reading' => 'ねむるまえに'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'okineate', 'text_variants' => ['okineate'], 'display_text' => '起きた後', 'reading' => 'おきたあと'],
            ['language' => 'japanese', 'difficulty' => 'intermediate', 'text' => 'shigotosuru', 'text_variants' => ['shigotosuru', 'sigotosuru'], 'display_text' => '仕事する', 'reading' => 'しごとする'],
            // 上級（advanced）- 5 ~ 8単語 20問
            [
                'language' => 'japanese',
                'difficulty' => 'advanced',
